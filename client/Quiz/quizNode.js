const dataNode = [
    ...
    },
    {
      ...
      option2: "net.createConnection(port[, host][, connectListener])",
    ...
    },
    {
      ...
      option2: "console.log('Current version: ' + process.getMemory());",
    ...
    },
    {
      ...
      option2: "fs.readDirectory(path[, mode], callback)",
      option3: "fs.read(path[, mode], callback);", 
    }
  ];
